...
class Admin_Shows_Controller extends Base_Controller{
	...
	{ 
        ...
        $show->video_link = CreateShowForm::get('video_link');
    ...
    public function post_add_photo($id)
    {
        ...
        $path = 'public_html/img/uploads/'.$image->id.'/';
	...
	public function get_edit($slug)
	{
        CreateShowForm::forget_input();
		$show = Show::find_by_slug($slug);
		return View::make('admin.shows.edit')->with('show',$show);
	}
	...
	{	 
        ...
        return Redirect::to_action( 'admin.shows@show',array($show->slug));
        }
