    ...
    $.fn.PINT_share = function(timing) {
        this.each(function() {
            ...
            $('#share-twitter').click(function() {
                window.open('http://twitter.com/home?status=' + encodeURIComponent("Advent Noir  2011 - 24 Classic Black & White Winter Memories") + '+-+' + encodeURIComponent(window.location.href), 'twitterwin', 'height=650,width=1024,scrollbars=yes');
            });
