<?php
Route::controller(array('home.user','home.pages','home.groups','home.showings','home.shows','home.habers','home.subjects',
                  'admin.dashboard','admin.groups','admin.shows', 'admin.theaters', 'admin.showings','admin.subjects' ,'admin.others','admin.habers'));
//views home
