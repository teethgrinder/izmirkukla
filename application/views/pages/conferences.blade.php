                ...
                <ul class="postit">
                    ...
                    <li>
                        <div class="post-it">
                            ...
                            <adress>
                                <p>{{ HTML::link_to_action('home.others@show',$other->place,array($other->id),array('data-reveal-id'=>$other->id)) }}</p>
                                <p>{{ HTML::link_to_action('home.others@show',$other->date,array($other->id),array('data-reveal-id'=>$other->id)) }}</p>
                            </adress>
                        </div>
                    </li>
                    @endforeach
