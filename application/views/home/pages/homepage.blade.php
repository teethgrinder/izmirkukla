...
@section('content')
 ...
 <div class="row">    
    ...
    <div class="nine columns push-three">
      ...
      <div id="slider">
        <img src="http://placehold.it/600x400&text=[img 1]" />
        <img src="http://placehold.it/600x400&text=[img 2]" />
        <img src="http://placehold.it/600x400&text=[img 3]" />
        <img src="http://placehold.it/600x400&text=[img 4]" />
      </div>
